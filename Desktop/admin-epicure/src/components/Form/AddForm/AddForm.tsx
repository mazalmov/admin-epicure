...
// const AddForm = ({ selectedRow, selectedTable, drillDownData,dataTable, handleClose ,action}: any) => {
...
//                 <Select
//                   multiple={key === 'dishIds'} 
//                   name={key}
//                   value={formData[key] || (key === 'dishIds' ? [] : '')}
//                   onChange={(e) => handleSelectChange(key, e.target.value)}
//                 >
//                   {drillDownData[selectedTable][key]?.map((item: any) => (
